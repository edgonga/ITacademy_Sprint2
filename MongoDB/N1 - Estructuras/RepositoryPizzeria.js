// This file is similar to Pizzeria.js but it keeps some validation schema features that
// don't work, but I want to conserve. Those features are placed in line 100 (allOf...)
// and in line 160 (expression...)
                                    ...
                                    /* , allOf: [ // Intentaremos validar que si el subdocumento Hamburguesa está presente,
...

                                        {
                                            $or: [{
                                                ...
                                                {
                                                    $and: [{
                                                            'Hamburguesa.NombreHamburguesa': {
                                                                $exists: true
                                                            }
                                                        },
                                                        {
                                                            'Hamburguesa.PrecioUnitario': {
                                                                $exists: true
                                                            }
                                                        },
                                                        {
